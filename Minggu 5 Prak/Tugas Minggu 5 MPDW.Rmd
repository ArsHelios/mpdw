...
```
Berdasarkan uji ADF tersebut, didapat p-value sebesar 0.5035 yang lebih besar dari taraf nyata 5% sehingga menandakan bahwa data tidak stasioner dalam rataan. Hal ini sesuai dengan hasil eksplorasi menggunakan plot deret waktu dan plot ACF.
...
```
Gambar di atas menunjukkan nilai λ optimum (rounded value) sebesar 0.57 dan selang kepercayaan 95% nilai memiliki batas bawah -0,07 dan batas atas 1,23. Selang tersebut memuat nilai 1 sehingga dapat dikatakan bahwa data bangkitan stasioner dalam ragam.
